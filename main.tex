...
\usepackage{microtype} % Improves typography for better readability
\usepackage{booktabs} % For better-looking tables
\usepackage{xcolor} % For consistent color scheme
\definecolor{arcblue}{RGB}{0, 102, 204} % Define brand color
\usepackage{titlesec} % For better section formatting
\usepackage{setspace} % For line spacing control
\usepackage{tcolorbox} % For highlighted boxes
\usepackage[left=1.25in,right=1in,top=1in,bottom=1in]{geometry} % Adjusted margins
\usepackage{qrcode} % For QR code

% Section formatting with brand color
\titleformat{\section}{\large\bfseries\color{arcblue}}{\thesection}{1em}{}
\titleformat{\subsection}{\normalsize\bfseries\color{arcblue}}{\thesubsection}{1em}{}

% Key point box definition
